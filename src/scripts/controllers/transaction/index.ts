...
import EthQuery from './../../../lib/eth-query/index';
...
import { isCustomNetwork } from '../../../utils/modules/network.utils';
import {
  fractionBN,
...
import { NetworkControllerState } from '../biport-mobile-network';
import Web3ProviderEngine from '../biport-mobile-network/lib/web3-provider-engine';
import Logger from '@common/Logger';
import { NetworkState } from '../biport-mobile-network/model/network';
