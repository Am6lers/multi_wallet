        ...
        <View style={styles.container}>
          ...
          <View style={styles.notificationText}>
            <Text text50BO style={styles.notificationText}>
              {TL.t('tokenManagement.addToken.notification')}
            </Text>
          </View>
          <TextField
            placeholder={TL.t('tokenManagement.addToken.placeholder')}
            enableErrors={true}
            autoFocus={true}
          ...
          <View style={styles.alert}>
            {!isValidate && address.length !== 0 && (
              <Text style={styles.notiText}>
                {TL.t('tokenManagement.addToken.error')}
              </Text>
            )}
        ...
        >
          <View paddingT-30 style={styles.modalView}>
            <Text text50BL marginB-20>
              {TL.t('tokenManagement.addToken.selectToken')}
            </Text>
            <TouchableOpacity
              margin-20
              padding-10
