...
const AddressField = ({ item }: { item: TokenItem }) => {
    ...
    return (
      ...
      >
        <Button
          ...
          disabled={showButton}
          onPress={() =>
            navigation.navigate('SetSendTokenAmount', { item: item })
          }
        />
      </KeyboardAvoidingView>
    );
...
interface SetSendTokenWhereProps {
  route: {
    params: {
      item: TokenItem;
    };
...
const SetSendTokenWhere = ({ route }: SetSendTokenWhereProps) => {
...
export default SetSendTokenWhere;
