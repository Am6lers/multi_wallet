...
interface SetSendTokenResultProps {
  route: {
    params: {
      item: TokenItem;
    };
...
const AssetDisplay = ({ item }: { item: TokenItem }) => {
  return (
    <View>
...
const SendTokenResult = ({ route }: SetSendTokenResultProps) => {
...
export default SendTokenResult;
