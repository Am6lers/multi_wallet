...
interface SetSendNFTAmountProps {
  route: {
    params: {
      item: NFTItem;
    };
  ...
  return (
    <View>
      <Button
        ...
        size="large"
        label="Next"
        onPress={() => navigation.navigate('SetSendNFTCharge', { item: item })}
      />
    </View>
  );
};
...
const AssetInfo = ({ item }: { item: NFTItem }) => {
  return (
...
const SetSendNFTAmount = ({ route }: SetSendNFTAmountProps) => {
...
export default SetSendNFTAmount;
